...
class LaunchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create launch" do
    assert_difference('Launch.count') do
      post launches_url, params: { launch: { article_id: @launch.article_id, provider: @launch.provider } }, as: :json
    end
  ...
  test "should update launch" do
    patch launch_url(@launch), params: { launch: { article_id: @launch.article_id, provider: @launch.provider } }, as: :json
    assert_response 200
  end
